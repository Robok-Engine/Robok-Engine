package dev.trindadedev.robokide.ui.components.editor.schemes
...
class SchemeRobok(context: Context) : SchemeDarcula() {
    ...
    init {
        ...
        setColor(EditorColorScheme.CURRENT_LINE, getColor(dev.trindadedev.robokide.R.color.scheme_robok_current_line)) // set the current line color
