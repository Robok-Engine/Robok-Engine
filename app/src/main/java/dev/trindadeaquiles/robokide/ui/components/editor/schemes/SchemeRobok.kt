package dev.trindadeaquiles.robokide.ui.components.editor.schemes
...
class SchemeRobok(context: Context) : SchemeDarcula() {
    ...
    init {
        ...
        setColor(EditorColorScheme.CURRENT_LINE, getColor(dev.trindadeaquiles.robokide.R.color.scheme_robok_current_line)) // set the current line color
        ...
        setColor(EditorColorScheme.FUNCTION_NAME, getAttrColor(com.google.android.material.R.attr.colorOnSurface)); // set function name colors
    }
