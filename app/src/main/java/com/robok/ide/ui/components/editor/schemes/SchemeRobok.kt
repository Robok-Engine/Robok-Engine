package com.robok.ide.ui.components.editor.schemes
...
class SchemeRobok(context: Context) : SchemeDarcula() {
    ...
    init {
        ...
        setColor(EditorColorScheme.CURRENT_LINE, getColor(com.robok.ide.R.color.scheme_robok_current_line)) // set the current line color
