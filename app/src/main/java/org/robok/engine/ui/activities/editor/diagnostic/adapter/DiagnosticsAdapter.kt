...
class DiagnosticsAdapter(private val listData: List<DiagnosticItem>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            LayoutDiagnosticItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ViewHolder(val binding: LayoutDiagnosticItemBinding, val context: Context) :
