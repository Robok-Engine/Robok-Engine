package org.gampiot.robok.feature.component.list
...
import org.gampiot.robok.feature.component.list.network.Commit
import org.gampiot.robok.feature.component.list.utils.itemsIndexed
        ...
        if (failed) {
            item {
                Column(
                    ...
                    Text(
                        text = stringResource(id = Strings.error_load_fail),
                        style = MaterialTheme.typography.labelLarge,
                        textAlign = TextAlign.Center
                    )

                    Button(onClick = { commits.retry() }) {
                        Text(text= stringResource(id = Strings.common_word_retry))
                    }
                }
            }
        }
