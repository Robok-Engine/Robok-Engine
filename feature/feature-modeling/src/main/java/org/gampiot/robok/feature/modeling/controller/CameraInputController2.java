package org.gampiot.robok.feature.modeling.controller;
...
import org.gampiot.robok.feature.modeling.controller.config.position.MovimentObject;
import org.gampiot.robok.feature.modeling.controller.config.position.Arrow;
...
public boolean pinch(Vector2 initialPointer1, Vector2 initialPointer2, Vector2 pointer1, Vector2 pointer2) {
    ...
    Vector2 initialMidpoint = new Vector2((initialPointer1.x + initialPointer2.x) / 2, (initialPointer1.y + initialPointer2.y) / 2);
    Vector2 currentMidpoint = new Vector2((pointer1.x + pointer2.x) / 2, (pointer1.y + pointer2.y) / 2);
    ...
    Vector3 cameraMovement = right.scl(-movementDelta.x * sensitivity * controller.translateUnits).add(up.scl(movementDelta.y * sensitivity * controller.translateUnits));
    ...
    // ModelInstance contém uma matriz de transformação (transform), que podemos usar para obter a posição do objeto
    ...
    controller.camera.position.set(objectPosition.x + distance, objectPosition.y + distance, objectPosition.z + distance);
	...
	protected CameraInputController2 (final CameraGestureListener gestureListener, final Camera camera) {
    ...
    private void drawCubeEdges2(ShapeRenderer shapeRenderer,
