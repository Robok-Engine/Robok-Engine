 ...
 */
package org.robok.engine.feature.editor.languages.java;
...
import org.robok.antlr4.java.Java8BaseListener;
import org.robok.antlr4.java.Java8ErrorListener;
import org.robok.antlr4.java.Java8Lexer;
import org.robok.antlr4.java.Java8Parser;
...
public class JavaLanguage implements Language, EditorListener, AntlrListener {
  ...
  @Override
  public void setEditorListener(@NonNull EditorListener value) {
    editorListener = value;
  }

  @Override
  public void setAntlrListener(@NonNull AntlrListener value) {
  ...
  public static class JavaListener extends Java8BaseListener {
    ...
    private ModifierAccess mapToModifierAccess(String text) {
      return switch (text) {
        case "private" -> ModifierAccess.PRIVATE;
        case "public" -> ModifierAccess.PUBLIC;
        case "protected" -> ModifierAccess.PROTECTED;
        default -> ModifierAccess.DEFAULT;
      };
    }
