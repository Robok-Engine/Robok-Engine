...
class SchemeRobokTH(context: Context) : EditorColorScheme() {
    ...
    init {
        ...
        setColor(
            ...
            resUtils.getColor(
                org.robok.engine.feature.editor.R.color.scheme_robok_non_printable_char
            ),
        )
        setColor(
            EditorColorScheme.STICKY_SCROLL_DIVIDER,
            resUtils.getColor(
                org.robok.engine.feature.editor.R.color.scheme_robok_sticky_scroll_divider
            ),
        )
        setColor(
        ...
        setColor(
            ...
            resUtils.getColor(
                org.robok.engine.feature.editor.R.color.scheme_robok_signature_text_normal
            ),
        )
        setColor(
            EditorColorScheme.SIGNATURE_TEXT_HIGHLIGHTED_PARAMETER,
            resUtils.getColor(
                org.robok.engine.feature.editor.R.color
                    .scheme_robok_signature_text_highlighted_parameter
            ),
        )
        setColor(
            EditorColorScheme.STATIC_SPAN_BACKGROUND,
            resUtils.getColor(
                org.robok.engine.feature.editor.R.color.scheme_robok_static_span_background
            ),
        )
        setColor(
            EditorColorScheme.STATIC_SPAN_FOREGROUND,
            resUtils.getColor(
                org.robok.engine.feature.editor.R.color.scheme_robok_static_span_foreground
            ),
        )
        setColor(
            EditorColorScheme.SIGNATURE_BACKGROUND,
            resUtils.getColor(
                org.robok.engine.feature.editor.R.color.scheme_robok_signature_background
            ),
        )
        setColor(
        ...
        setColor(
            ...
            resUtils.getColor(
                org.robok.engine.feature.editor.R.color.scheme_robok_line_number_current
            ),
        )
        setColor(
