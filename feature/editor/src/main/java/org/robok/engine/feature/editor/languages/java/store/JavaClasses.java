...
public final class JavaClasses {
  ...
  public static final HashMap<String, String> getClasses() {
    ...
    classes.put(
        "Double",
        "java.lang.Double"); // Double class for handling double precision floating point numbers
    classes.put("Boolean", "java.lang.Boolean"); // Boolean class for handling boolean values
    classes.put(
        "Character", "java.lang.Character"); // Character class for handling single characters
    ...
    classes.put(
        "LinkedList", "java.util.LinkedList"); // LinkedList class for linked list implementation
    ...
    classes.put(
        "LinkedHashMap",
        "java.util.LinkedHashMap"); // LinkedHashMap class for maintaining insertion order in a map
    classes.put(
        "Arrays", "java.util.Arrays"); // Arrays class for utility methods for working with arrays
    classes.put(
        "Date",
