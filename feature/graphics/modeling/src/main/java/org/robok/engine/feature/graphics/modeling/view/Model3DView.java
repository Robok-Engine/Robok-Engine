package org.robok.engine.feature.graphics.modeling.view;
...
import org.robok.engine.feature.graphics.modeling.objects.ObjectsCreator;
...
public class Model3DView extends ApplicationAdapter {
  ...
  public void render() {
    ...
    for (SceneObject scene : SceneObject.getSceneObjects()) {
      ...
      p++;
      text +=
          "\nObjetos adicionados: " + p + "\nModelo: " + scene.getModelInstance().model.toString();
    }
