  ...
  public void setTo(final View v) {
    ...
    if (!hasAttribute("layout_width")) {
      ...
      if (!mParser.getName().equals("include"))
        debug.logE(
            mParser.getLineNumber()
                + "行 "
                + mParser.getColumnNumber()
                + "列："
                + mParser.getName()
                + " layout_width 不能忽略，已经自动设置为wrap_content。");
    }
      ...
      if (!mParser.getName().equals("include"))
        debug.logE(
            mParser.getLineNumber()
                ...
                + "列："
                + mParser.getName()
                + " layout_height 不能忽略，已经自动设置为wrap_content。");
    }
    ...
    for (int i = 0; i < getAttributeCount(); i++) {
      ...
      if (mParser.getAttributeNamespace(i).equals(AndroidXmlParser.ANDROID_NS))
        switch (name) {
          ...
          case "src":
            Utils.invoke(
                v, "setImageDrawable", new Class[] {Drawable.class}, resource.getDrawable(value));
            continue;
          case "visibility":
          ...
          case "singleLine":
            Utils.invoke(
                v, "setSingleLine", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "textColor":
          ...
          case "textIsSelectable":
            Utils.invoke(
                v, "setTextIsSelectable", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "textSize":
            Utils.invoke(
                v,
          ...
          case "adjustViewBounds":
            Utils.invoke(
                v, "setAdjustViewBounds", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "baseLine":
          ...
          case "textOff":
            {
              Utils.invoke(
                  v, "setTextOff", new Class[] {CharSequence.class}, resource.getString(value));
          ...
          case "textOn":
            {
              Utils.invoke(
                  v, "setTextOn", new Class[] {CharSequence.class}, resource.getString(value));
              boolean b = (boolean) Utils.invoke(v, "isChecked", null);
              Utils.invoke(v, "setChecked", new Class[] {boolean.class}, b);
              continue;
            }
          case "enabled":
            if (!Boolean.parseBoolean(value))
              Utils.invoke(
                  v, "setEnabled", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "switchMinWidth":
          ...
          case "thumbTextPadding":
            Utils.invoke(
                v, "setThumbTextPadding", new Class[] {int.class}, Integer.parseInt(value));
            continue;
          case "clipChildren":
            Utils.invoke(
                v, "setClipChildren", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          ...
          case "clipToPadding":
            Utils.invoke(
                v, "setClipToPadding", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          ...
          case "spinnersShown":
            Utils.invoke(
                v, "setSpinnersShown", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          ...
          case "cropToPadding":
            Utils.invoke(
                v, "setCropToPadding", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "baselineAligned":
            Utils.invoke(
                v, "setBaselineAligned", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          ...
          case "indeterminate":
            Utils.invoke(
                v, "setIndeterminate", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          ...
          case "isIndicator":
            Utils.invoke(
                v, "setIsIndicator", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "stepSize":
          ...
          case "fillViewport":
            Utils.invoke(
                v, "setFillViewport", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "alignmentMode":
          ...
          case "textAppearance":
            {
              ...
              Utils.invoke(
                  v, "setTextAppearance", new Class[] {Context.class, int.class}, ctx, attrid);
              continue;
            }
          ...
          case "clickable":
            Utils.invoke(
                v, "setClickable", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          ...
          case "drawingCacheQuality":
            Utils.invoke(
                v, "setDrawingCacheQuality", new Class[] {int.class}, Integer.parseInt(value));
            continue;
          ...
          case "requiresFadingEdge":
            {
              ...
              switch (Integer.parseInt(value)) {
                ...
                case 0x00001000: // h
                  Utils.invoke(
                      v, "setHorizontalFadingEdgeEnabled", new Class[] {boolean.class}, true);
                  continue;
                case 0x00002000: // v
                  Utils.invoke(
                      v, "setVerticalFadingEdgeEnabled", new Class[] {boolean.class}, true);
                  continue;
                case 0x00003000: // hv
                  Utils.invoke(
                      v, "setHorizontalFadingEdgeEnabled", new Class[] {boolean.class}, true);
          ...
          case "fadingEdgeLength":
            Utils.invoke(
                v, "setFadingEdgeLength", new Class[] {int.class}, Integer.parseInt(value));
            continue;
          ...
          case "focusable":
            Utils.invoke(
                v, "setFocusable", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          ...
          case "foreground":
            Utils.invoke(
                v, "setForeground", new Class[] {Drawable.class}, resource.getDrawable(value));
            continue;
          case "foregroundGravity":
            Utils.invoke(
                v, "setForegroundGravity", new Class[] {int.class}, Integer.parseInt(value));
            continue;
          ...
          case "isScrollContainer":
            Utils.invoke(
                v, "setScrollContainer", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "keepScreenOn":
            Utils.invoke(
                v, "setKeepScreenOn", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "labelFor":
          ...
          case "longClickable":
            Utils.invoke(
                v, "setLongClickable", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "nextFocusDown":
          ...
          case "nextFocusForward":
            Utils.invoke(
                v, "setNextFocusForwardId", new Class[] {int.class}, resource.getId(value));
            continue;
          case "nextFocusLeft":
          ...
          case "saveEnabled":
            Utils.invoke(
                v, "setSaveEnabled", new Class[] {boolean.class}, Boolean.parseBoolean(value));
            continue;
          case "scrollX":
          ...
          case "scrollbarAlwaysDrawHorizontalTrack":
            // Utils.invoke(v, "setHorizontalScrollBarEnabled", new Class[]{boolean.class},
            // Boolean.parseBoolean(value));
            continue;
          case "scrollbarAlwaysDrawVerticalTrack":
            // Utils.invoke(v, "setVerticalScrollBarEnabled", new Class[]{boolean.class},
            // Boolean.parseBoolean(value));
            continue;
          ...
          case "scrollbarFadeDuration":
            Utils.invoke(
                v, "setScrollBarFadeDuration", new Class[] {int.class}, Integer.parseInt(value));
            continue;
          case "scrollbarSize":
        ...
        try {
          ...
          switch (suffix) {
            case "sp":
              return String.valueOf(
                  TypedValue.applyDimension(
                      TypedValue.COMPLEX_UNIT_SP, v, ctx.getResources().getDisplayMetrics()));
            case "dp":
            case "dip":
              return String.valueOf(
                  TypedValue.applyDimension(
            ...
            case "pt":
              return String.valueOf(
                  TypedValue.applyDimension(
                      TypedValue.COMPLEX_UNIT_PT, v, ctx.getResources().getDisplayMetrics()));
            case "px":
              return String.valueOf(v);
            case "mm":
              return String.valueOf(
                  TypedValue.applyDimension(
                      TypedValue.COMPLEX_UNIT_MM, v, ctx.getResources().getDisplayMetrics()));
            case "in":
              return String.valueOf(
                  TypedValue.applyDimension(
                      TypedValue.COMPLEX_UNIT_IN, v, ctx.getResources().getDisplayMetrics()));
          }
