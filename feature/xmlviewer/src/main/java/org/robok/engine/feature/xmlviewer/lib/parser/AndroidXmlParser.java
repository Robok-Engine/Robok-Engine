        ...
        switch (eventType) {
          ...
          case XmlPullParser.START_TAG:
            ...
            if (view instanceof ViewGroup) {
              ...
              if (listener != null) listener.onJoin(viewGroup2, new ReadOnlyParser(parser));
            }
            ...
            if (lastView == viewGroup) {
              ...
              debug.logE(
                  parser.getLineNumber()
                      ...
                      + parser.getColumnNumber()
                      + "列："
                      + lastView.getClass().getName()
                      + "不能转换为ViewGroup，已经自动忽略错误的xml片段。");
            }
          ...
          case XmlPullParser.END_TAG:
            ...
            if (v instanceof ViewGroup) {
              ...
              if (listener != null) listener.onRevert(viewGroup1, new ReadOnlyParser(parser));
            }
            break;
        }
