package org.robok.engine.feature.xmlviewer.ui.treeview;
...
import org.robok.engine.feature.xmlviewer.LayoutItemType;
import org.robok.engine.feature.xmlviewer.R;
...
public class ViewBean implements LayoutItemType {
  ...
  static {
    ...
    imgMap.put(
        AutoCompleteTextView.class.getSimpleName(), R.drawable.ic_palette_auto_complete_text_view);
    imgMap.put(
    ...
    // imgMap.put(ProgressBar.class.getSimpleName()+"_horizontal",
    // R.drawable.ic_palette_progress_bar_horizontal);
    ...
    // imgMap.put(LinearLayout.class.getSimpleName()+"_horz",
    // R.drawable.ic_palette_linear_layout_horz);
    // imgMap.put(LinearLayout.class.getSimpleName()+"_vert",
    // R.drawable.ic_palette_linear_layout_vert);
    ...
    imgMap.put(
        HorizontalScrollView.class.getSimpleName(), R.drawable.ic_palette_horizontal_scroll_view);
    ...
    imgMap.put(
        FloatingActionButton.class.getSimpleName(), R.drawable.ic_palette_floating_action_button);
    ...
    imgMap.put(
        BottomNavigationView.class.getSimpleName(), R.drawable.ic_palette_bottom_navigation_view);
