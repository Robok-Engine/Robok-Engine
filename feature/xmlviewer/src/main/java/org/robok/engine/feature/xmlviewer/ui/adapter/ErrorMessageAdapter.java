package org.robok.engine.feature.xmlviewer.ui.adapter;
...
import org.robok.engine.feature.xmlviewer.lib.utils.XmlMessage;
...
public class ErrorMessageAdapter extends RecyclerView.Adapter<ErrorMessageAdapter.ViewHolder> {
  ...
  public ErrorMessageAdapter() {
    ...
    ma.setListener(
        new MessageArray.OnNewMessageListener() {
          @Override
