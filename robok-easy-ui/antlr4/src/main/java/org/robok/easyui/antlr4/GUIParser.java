...
public class GUIParser extends Parser {
  ...
  public static final int T__0 = 1,
      ...
      IDENTIFIER_DOT = 11,
      WS = 12;
  public static final int RULE_guiFile = 0,
      RULE_component = 1,
      RULE_argumentList = 2,
      RULE_argument = 3,
      RULE_value = 4;
  ...
  private static String[] makeRuleNames() {
    return new String[] {"guiFile", "component", "argumentList", "argument", "value"};
  }
  ...
  public static class GuiFileContext extends ParserRuleContext {
    public TerminalNode EOF() {
      return getToken(GUIParser.EOF, 0);
    }
  ...
  public static class ComponentContext extends ParserRuleContext {
    public TerminalNode IDENTIFIER() {
      return getToken(GUIParser.IDENTIFIER, 0);
    }
  ...
  public static class ArgumentContext extends ParserRuleContext {
    ...
    public TerminalNode IDENTIFIER_COLON() {
      return getToken(GUIParser.IDENTIFIER_COLON, 0);
    }
  ...
  public static class ValueContext extends ParserRuleContext {
    public TerminalNode STRING() {
      return getToken(GUIParser.STRING, 0);
    }

    public TerminalNode NUMBER() {
      return getToken(GUIParser.NUMBER, 0);
    }

    public TerminalNode IDENTIFIER_DOT() {
      return getToken(GUIParser.IDENTIFIER_DOT, 0);
    }
